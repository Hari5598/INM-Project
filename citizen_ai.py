...
Original file is located at
    https://colab.research.google.com/drive/1lJydaWp2oRhi6ApPiARS90GJdzQz8q-3
"""
...
def citizen_interaction(query):
    prompt = f"""As a government assistant, provide accurate and helpful information about:
    {query}"""
    return generate_response(prompt, max_length=1000)
